        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            ...
            <a class="navbar-brand" href="/"><img src="{{asset('images/logo.png')}}" class="logo" alt=""></a>
                ...
                <div class="d-flex justify-content-center justify-content-md-end">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/">Return to the home</a></li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav pt-0" style="z-index: 4">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu2">
                ...
                <li class="nav-item {{ request()->routeIs('categories*') ?  'active' : '' }}"><a class="nav-link" href="{{ route('categories.index')}}">Categories</a></li>
                <li class="nav-item {{ request()->routeIs('products*') ?  'active' : '' }}"><a class="nav-link" href="{{ route('products.index')}}">Products</a></li>
